...
<div class="card">
  ...
  <div class="kpi-row" style="margin-top:0;margin-bottom:24px">
    <div class="kpi"><div class="lbl">US 10Y</div><div class="val">4.31%</div><div class="chg up">+6.40bp</div></div>
    <div class="kpi"><div class="lbl">US 2Y</div><div class="val">3.593%</div><div class="chg down">−0.70bp</div></div>
    <div class="kpi"><div class="lbl">2s10s</div><div class="val">71.7bp</div><div class="chg">스프레드</div></div>
  </div>
  ...
  <ul class="detail-list">
    <li>크레딧: HYG −0.21% · LQD −0.40% · EMB −0.49% — 신용위험 신호 미미</li>
    <li>인플레 연동: <strong style="color:var(--up)">TIPS +0.29%</strong> — 유가 하락에도 인플레 기대 유지</li>
    <li>한국 GDP +1.7% 서프라이즈 → <strong>한은 조기 인하 기대 후퇴</strong></li>
  </ul>
